...
public class GameScore {
	...
	public GameScore(ScoreService scoreService) {
	...
	public void increaseScore(Player player) {
		if (this.scores.containsKey(player)) {
			...
			this.scoreService.addScoreEntryIfEligible(player.getName(), playerScore);
		}

		this.scoreService.increasePlayerXp(player.getName(), 10);
